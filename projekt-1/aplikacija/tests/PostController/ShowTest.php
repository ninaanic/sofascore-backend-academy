...
final class ShowTest extends KernelTestCase
{
    use AssertTrait;
    ...
    public function run(): void
    {
        ...
        $response = $postController->show(1);

        $this->assert(json_encode(['id' => 1, 'title' => 'Title1', 'text' => 'Text1', 'status' => 'published', 'dateCreated' => '2022-03-04 15:23:16']), $response->getContent());
