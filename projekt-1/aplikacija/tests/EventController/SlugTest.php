...
final class SlugTest extends KernelTestCase
{
    ...
    public function run(): void
    {
        ...
        $response = $controller->slug('a07cd475a337c1cd16e1e567f82d720b5d969a7238642ac14a5cfc73f1376a07');
        ...
        $this->assert(json_encode([
            ["id" => 1,
            "slug" => "a07cd475a337c1cd16e1e567f82d720b5d969a7238642ac14a5cfc73f1376a07",
            "start_date" => "2003-12-14 16:00:00",
            "home_score" => 0,
            "away_score" => 1],
        ], JSON_PRETTY_PRINT), $response->getContent());

        $response = $controller->slug('f8016e80ae66924ada6536c50072c8a67666b06c80bbd1e63f102761ff1d23d4');

        $this->assert(200, $response->getStatusCode());
        $this->assert(['content-type' => 'application/json'], $response->getHeaders());
        $this->assert(json_encode([
            ["id" => 2,
            "slug" => "f8016e80ae66924ada6536c50072c8a67666b06c80bbd1e63f102761ff1d23d4",
            "start_date" => "2009-04-03 23:00:00",
            "home_score" => 92,
            "away_score" => 97],
        ], JSON_PRETTY_PRINT), $response->getContent());
    }
