...
final class DateSportTest extends KernelTestCase
{
    use AssertTrait;
    ...
    public function run(): void
    {
        ...
        $response = $controller->date_sport('football', '2003-12-14 16:00:00');
        ...
        $response = $controller->date_sport('basketball', '2009-04-03 23:00:00');
