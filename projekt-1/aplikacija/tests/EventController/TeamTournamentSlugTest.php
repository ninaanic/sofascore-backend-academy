...
final class TeamTournamentSlugTest extends KernelTestCase
{
    use AssertTrait;
    ...
    public function run(): void
    {
        ...
        $response = $controller->team_tournament_slug('real-zaragoza', 'laliga');
        ...
        $response = $controller->team_tournament_slug('miami-heat', 'nba');
